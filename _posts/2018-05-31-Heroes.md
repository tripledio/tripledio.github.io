...
In this post I would like to discuss a human trait and the impact it can have on software development. The trait I am talking about is the human tendency to place people upon a pedestal. Because whether it is ourselves or others, people love heroes. I will analyze a couple of the different software hero categories that I've encountered over the years. Note that I am defining heroics[^hero] broader than the typical "alpha behavior" that usually comes to mind. After all, there is a difference between aspiring to be a hero and being regarded as a hero by other people. I'll discuss the impact of heroism ibn the software industry on the different parties involved. Namely the 'heroes', their peers, the customers and of course the software itself. 
