...
author: domenique
disqus: false
excerpt: This post will briefly describe the well known SOLID principles, after which we will dive deeper into the 6 other, lesser known principles. This post will ultimately become a series, so do check back for follow-up articles.
---
# SOLID Principles
