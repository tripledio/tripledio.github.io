...
![Mob 1](/img/posts/communication/triple-d-mob-1.jpg "Triple D on a learning day"){:width=500px : .center-image;  style="color:red; margin=10px";}
![Mob 2](/img/posts/communication/triple-d-mob-2.jpg "Triple D on a learning day"){:width=500px : .center-image;  style="color:red; margin=10px";}
![Mob 3](/img/posts/communication/triple-d-mob-sander.jpg "Triple D on a learning day"){:width=500px : .center-image;  style="color:red; margin=10px";}
![Mob 4](/img/posts/communication/triple-d-mob-yves.jpg "Triple D on a learning day"){:width=500px : .center-image;  style="color:red; margin=10px";}

*Triple D during a learning day. Practising communication skills as well as engineering skills* {: style="color:red"}
