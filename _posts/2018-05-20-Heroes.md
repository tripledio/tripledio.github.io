...
In this post I would like to discuss a human trait and how it affects software development. I'm talking about the tendency to place certain people on a pedestal. Because whether it is ourselves or others, people love heroes. In this post I will analyze a couple of the different categories of heroes that I've encountered over the years. I am defining heroics[^hero] broader than the typical "alpha behavior" that usually comes to mind. After all, there is a difference between wanting to be an hero and being regarded as an hero. The latter requires other people. I'll discuss the impact of heroism on all parties involved: the 'hero', their peers, the customer and the software. 

Over the years, I have encountered developer hero types in a variety of different forms in almost every company I worked for. In broad terms an hero is a type of developer that is well respected and revered by their direct peers. Known by management for getting things to work quickly in the face of a looming deadline. Or they are the ones the company constantly relies on to save the day when the shit hits the fan. These developers throw themselves in the midst of "battle" time and time again. Saving the day. To their fellow software developers they generally have the reputation of being very 'smart', for being true experts. Oh, what would we do without them?

![Gunslingers](/img/posts/heroes/gunslingers.png)

## Wild west

When talking about heroes I think of them as the cowboy gunslingers from the Wild West. The classic cowboys from the movies, that draw fast and shoot straight. Who ride into town, save the day in an epic gun fight and then ride of in the sunset. As a kid, who did not aspire to be such an hero? 
...
One can be multiple of these patterns at the same time in varying degrees. One can evolve into another over time depending on changes in the project, team composition, roles taken. As an example someone can start as a young buck working hard on a big project. Once the project is delivered and the software is being maintained and extended the young buck can evolve into a lone ranger, if they are the only ones that are able to maintain the software, an hero or a bully when new team members need to start working on the software, a member of a posse when the team that delivered the software sticks together to maintain it. 
...
>Know the difference between an heroic show off and a competent professional. 
...
> "You know what I like about you? You are not an hero. I don't want you to be an hero. Heroes do stupid things and they die."
